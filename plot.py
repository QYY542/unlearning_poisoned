...
plt.plot(fpr_clean, tpr_clean, label=f'Clean vs Clean remove Sample (area = {roc_auc_clean:.2f})')
...
plt.plot(fpr_unlearn, tpr_unlearn, label=f'Unlearn vs Unlearn remove Sample (area = {roc_auc_unlearn:.2f})')
...
plt.plot(fpr_poisoned, tpr_poisoned, label=f'Poisoned vs Poisoned remove Sample (area = {roc_auc_poisoned:.2f})')
...
print("Adv_MIA (投毒后优势):", AdvMIA)
print("AdvUL_MIA (近似遗忘后优势):", AdvUL_MIA_unlearn)
print("AdvUL_MIA (完全重训练后优势):", AdvUL_MIA_clean)
print("### 结果 ###")
print(f"AdvUL（近似遗忘）: {AdvUL_MIA_unlearn-AdvMIA}")
print(f"AdvUL（完全重训练）: {AdvUL_MIA_clean-AdvMIA}")
...
print("### Clean ###")
print("Clean probabilities:", clean_probs)
print("Clean removed probabilities:", clean_removed_probs)
print("Adv_Clean:", clean_probs-clean_removed_probs)

print("### Unlearn ###")
print("Unlearn probabilities:", unlearn_probs)
print("Unlearn removed probabilities:", unlearn_removed_probs)
print("Adv_Unlearn:", unlearn_probs-unlearn_removed_probs)

print("### Poisoned ###")
print("Poisoned probabilities:", poisoned_probs)
print("Poisoned removed probabilities:", poisoned_removed_probs)
print("Adv_Poisoned:", poisoned_probs-poisoned_removed_probs)